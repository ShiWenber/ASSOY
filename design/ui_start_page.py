...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_view_free_t = QtWidgets.QPushButton(self.centralwidget)
        self.pb_view_free_t.setMinimumSize(QtCore.QSize(150, 23))
        self.pb_view_free_t.setMaximumSize(QtCore.QSize(200, 50))
        self.pb_view_free_t.setStyleSheet("font: 14pt \"Agency FB\";")
        self.pb_view_free_t.setObjectName("pb_view_free_t")
        self.horizontalLayout_4.addWidget(self.pb_view_free_t)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_view_free_t.setText(_translate("MainWindow", "查看空闲表"))
